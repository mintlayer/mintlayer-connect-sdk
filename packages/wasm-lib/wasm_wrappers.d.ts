 ...
 */
export function encode_witness_htlc_refund_multisig(sighashtype: SignatureHashType, private_key: Uint8Array, key_index: number, input_witness: Uint8Array, multisig_challenge: Uint8Array, transaction: Uint8Array, input_utxos: Uint8Array, input_index: number, additional_info: TxAdditionalInfo, current_block_height: bigint, network: Network): Uint8Array;
 ...
 * `input_utxos` and `additional_info` have the same format and requirements as in `encode_witness`.
 */
export function encode_witness_htlc_refund_single_sig(sighashtype: SignatureHashType, private_key: Uint8Array, input_owner_destination: string, transaction: Uint8Array, input_utxos: Uint8Array, input_index: number, additional_info: TxAdditionalInfo, current_block_height: bigint, network: Network): Uint8Array;
 ...
 * `input_utxos` and `additional_info` have the same format and requirements as in `encode_witness`.
 */
export function encode_witness_htlc_spend(sighashtype: SignatureHashType, private_key: Uint8Array, input_owner_destination: string, transaction: Uint8Array, input_utxos: Uint8Array, input_index: number, secret: Uint8Array, additional_info: TxAdditionalInfo, current_block_height: bigint, network: Network): Uint8Array;
...
export interface InitOutput {
    ...
    readonly encode_multisig_challenge: (a: number, b: number, c: number, d: number) => [number, number, number, number];
    readonly encode_outpoint_source_id: (a: number, b: number, c: number) => [number, number];
    readonly encode_partially_signed_transaction: (a: number, b: number, c: number, d: number, e: number, f: number, g: number, h: number, i: number, j: number, k: any, l: number) => [number, number, number, number];
    readonly encode_signed_transaction: (a: number, b: number, c: number, d: number) => [number, number, number, number];
    readonly encode_signed_transaction_intent: (a: number, b: number, c: number, d: number) => [number, number, number, number];
    readonly encode_stake_pool_data: (a: number, b: number, c: number, d: number, e: number, f: number, g: number, h: number, i: number, j: number) => [number, number, number, number];
    readonly encode_transaction: (a: number, b: number, c: number, d: number, e: bigint) => [number, number, number, number];
    readonly encode_witness: (a: number, b: number, c: number, d: number, e: number, f: number, g: number, h: number, i: number, j: number, k: any, l: bigint, m: number) => [number, number, number, number];
    readonly encode_witness_htlc_refund_multisig: (a: number, b: number, c: number, d: number, e: number, f: number, g: number, h: number, i: number, j: number, k: number, l: number, m: number, n: any, o: bigint, p: number) => [number, number, number, number];
    readonly encode_witness_htlc_refund_single_sig: (a: number, b: number, c: number, d: number, e: number, f: number, g: number, h: number, i: number, j: number, k: any, l: bigint, m: number) => [number, number, number, number];
    readonly encode_witness_htlc_spend: (a: number, b: number, c: number, d: number, e: number, f: number, g: number, h: number, i: number, j: number, k: number, l: number, m: any, n: bigint, o: number) => [number, number, number, number];
    readonly encode_witness_no_signature: () => [number, number];
    readonly estimate_transaction_size: (a: number, b: number, c: number, d: number, e: number, f: number, g: number) => [number, number, number];
    readonly extended_public_key_from_extended_private_key: (a: number, b: number) => [number, number, number, number];
    readonly extract_htlc_secret: (a: number, b: number, c: number, d: number, e: number, f: number) => [number, number, number, number];
    readonly fungible_token_issuance_fee: (a: bigint, b: number) => number;
    readonly get_delegation_id: (a: number, b: number, c: number) => [number, number, number, number];
    readonly get_order_id: (a: number, b: number, c: number) => [number, number, number, number];
    readonly get_pool_id: (a: number, b: number, c: number) => [number, number, number, number];
    readonly get_token_id: (a: number, b: number, c: bigint, d: number) => [number, number, number, number];
    readonly get_transaction_id: (a: number, b: number, c: number) => [number, number, number, number];
    readonly make_change_address: (a: number, b: number, c: number) => [number, number, number, number];
    readonly make_change_address_public_key: (a: number, b: number, c: number) => [number, number, number, number];
    readonly make_default_account_privkey: (a: number, b: number, c: number) => [number, number, number, number];
    readonly make_private_key: () => [number, number];
    readonly make_receiving_address: (a: number, b: number, c: number) => [number, number, number, number];
    readonly make_receiving_address_public_key: (a: number, b: number, c: number) => [number, number, number, number];
    readonly make_transaction_intent_message_to_sign: (a: number, b: number, c: number, d: number) => [number, number, number, number];
    readonly multisig_challenge_to_address: (a: number, b: number, c: number) => [number, number, number, number];
    readonly nft_issuance_fee: (a: bigint, b: number) => number;
    readonly pubkey_to_pubkeyhash_address: (a: number, b: number, c: number) => [number, number, number, number];
    readonly public_key_from_private_key: (a: number, b: number) => [number, number, number, number];
    readonly sign_challenge: (a: number, b: number, c: number, d: number) => [number, number, number, number];
    readonly sign_message_for_spending: (a: number, b: number, c: number, d: number) => [number, number, number, number];
    readonly staking_pool_spend_maturity_block_count: (a: bigint, b: number) => bigint;
    ...
    readonly verify_challenge: (a: number, b: number, c: number, d: number, e: number, f: number, g: number) => [number, number, number];
    readonly verify_signature_for_spending: (a: number, b: number, c: number, d: number, e: number, f: number) => [number, number, number];
    readonly verify_transaction_intent: (a: number, b: number, c: number, d: number, e: number, f: number, g: number) => [number, number];
    readonly encode_create_order_output: (a: number, b: number, c: number, d: number, e: number, f: number, g: number, h: number, i: number) => [number, number, number, number];
    readonly encode_output_coin_burn: (a: number) => [number, number, number, number];
    readonly encode_output_create_delegation: (a: number, b: number, c: number, d: number, e: number) => [number, number, number, number];
    readonly encode_output_create_stake_pool: (a: number, b: number, c: number, d: number, e: number) => [number, number, number, number];
    readonly encode_output_data_deposit: (a: number, b: number) => [number, number, number, number];
    readonly encode_output_delegate_staking: (a: number, b: number, c: number, d: number) => [number, number, number, number];
    readonly encode_output_htlc: (a: number, b: number, c: number, d: number, e: number, f: number, g: number, h: number, i: number, j: number, k: number, l: number) => [number, number, number, number];
    readonly encode_output_issue_fungible_token: (a: number, b: number, c: number, d: number, e: number, f: number, g: number, h: number, i: number, j: number, k: bigint, l: number) => [number, number, number, number];
    readonly encode_output_issue_nft: (a: number, b: number, c: number, d: number, e: number, f: number, g: number, h: number, i: number, j: number, k: number, l: number, m: number, n: number, o: number, p: number, q: number, r: number, s: number, t: number, u: bigint, v: number) => [number, number, number, number];
    readonly encode_output_lock_then_transfer: (a: number, b: number, c: number, d: number, e: number, f: number) => [number, number, number, number];
    readonly encode_output_produce_block_from_stake: (a: number, b: number, c: number, d: number, e: number) => [number, number, number, number];
    readonly encode_output_token_burn: (a: number, b: number, c: number, d: number) => [number, number, number, number];
    readonly encode_output_token_lock_then_transfer: (a: number, b: number, c: number, d: number, e: number, f: number, g: number, h: number) => [number, number, number, number];
    readonly encode_output_token_transfer: (a: number, b: number, c: number, d: number, e: number, f: number) => [number, number, number, number];
    readonly encode_output_transfer: (a: number, b: number, c: number, d: number) => [number, number, number, number];
    ...
    readonly encode_input_for_change_token_authority: (a: number, b: number, c: number, d: number, e: bigint, f: number) => [number, number, number, number];
    readonly encode_input_for_change_token_metadata_uri: (a: number, b: number, c: number, d: number, e: bigint, f: number) => [number, number, number, number];
    readonly encode_input_for_conclude_order: (a: number, b: number, c: bigint, d: bigint, e: number) => [number, number, number, number];
    readonly encode_input_for_fill_order: (a: number, b: number, c: number, d: number, e: number, f: bigint, g: bigint, h: number) => [number, number, number, number];
    readonly encode_input_for_freeze_order: (a: number, b: number, c: bigint, d: number) => [number, number, number, number];
    readonly encode_input_for_freeze_token: (a: number, b: number, c: number, d: bigint, e: number) => [number, number, number, number];
    readonly encode_input_for_lock_token_supply: (a: number, b: number, c: bigint, d: number) => [number, number, number, number];
    readonly encode_input_for_mint_tokens: (a: number, b: number, c: number, d: bigint, e: number) => [number, number, number, number];
    readonly encode_input_for_unfreeze_token: (a: number, b: number, c: bigint, d: number) => [number, number, number, number];
    readonly encode_input_for_unmint_tokens: (a: number, b: number, c: bigint, d: number) => [number, number, number, number];
    readonly encode_input_for_utxo: (a: number, b: number, c: number) => [number, number, number, number];
    readonly encode_input_for_withdraw_from_delegation: (a: number, b: number, c: number, d: bigint, e: number) => [number, number, number, number];
    readonly internal_verify_witness: (a: number, b: number, c: number, d: number, e: number, f: number, g: number, h: number, i: number, j: number, k: any, l: bigint, m: number) => [number, number];
