 ...
 */
export function extended_public_key_from_extended_private_key(private_key_bytes: Uint8Array): Uint8Array;
/**
 * From an extended public key create a receiving public key for a given key index
 * derivation path: current_derivation_path/0/key_index
 */
export function make_receiving_address_public_key(extended_public_key_bytes: Uint8Array, key_index: number): Uint8Array;
/**
 * From an extended public key create a change public key for a given key index
 * derivation path: current_derivation_path/1/key_index
 */
export function make_change_address_public_key(extended_public_key_bytes: Uint8Array, key_index: number): Uint8Array;
/**
 ...
 */
export function encode_signed_transaction_intent(signed_message: Uint8Array, signatures: any): Uint8Array;
/**
 ...
 */
export function encode_input_for_fill_order(order_id: string, fill_amount: Amount, destination: string, nonce: bigint, network: Network): Uint8Array;
/**
 * Given an order id create an input that concludes the order.
 */
export function encode_input_for_conclude_order(order_id: string, nonce: bigint, network: Network): Uint8Array;
/**
...
export interface InitOutput {
  ...
  readonly encode_signed_transaction_intent: (a: number, b: number, c: any) => [number, number, number, number];
  ...
  readonly get_token_id: (a: number, b: number, c: number) => [number, number, number, number];
  ...
  readonly encode_witness: (a: number, b: number, c: number, d: number, e: number, f: number, g: number, h: number, i: number, j: number, k: number) => [number, number, number, number];
  readonly encode_witness_htlc_secret: (a: number, b: number, c: number, d: number, e: number, f: number, g: number, h: number, i: number, j: number, k: number, l: number, m: number) => [number, number, number, number];
  readonly encode_multisig_challenge: (a: number, b: number, c: number, d: number) => [number, number, number, number];
  readonly encode_witness_htlc_multisig: (a: number, b: number, c: number, d: number, e: number, f: number, g: number, h: number, i: number, j: number, k: number, l: number, m: number, n: number) => [number, number, number, number];
  ...
  readonly encode_input_for_fill_order: (a: number, b: number, c: number, d: number, e: number, f: bigint, g: number) => [number, number, number, number];
  readonly encode_input_for_conclude_order: (a: number, b: number, c: bigint, d: number) => [number, number, number, number];
