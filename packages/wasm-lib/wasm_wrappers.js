 ...
 * @returns {any}
 */
export function decode_partially_signed_transaction_to_js(transaction, network) {
 ...
 * @returns {any}
 */
export function decode_transaction_to_js(transaction, network) {
    const ptr0 = passArray8ToWasm0(transaction, wasm.__wbindgen_malloc);
    const len0 = WASM_VECTOR_LEN;
 ...
 * @returns {Uint8Array}
 */
export function encode_create_order_output(ask_amount, ask_token_id, give_amount, give_token_id, conclude_address, network) {
 ...
 * @returns {Uint8Array}
 */
export function encode_input_for_change_token_authority(token_id, new_authority, nonce, network) {
 ...
 * @returns {Uint8Array}
 */
export function encode_input_for_change_token_metadata_uri(token_id, new_metadata_uri, nonce, network) {
    const ptr0 = passStringToWasm0(token_id, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
 ...
 * @returns {Uint8Array}
 */
export function encode_input_for_conclude_order(order_id, nonce, current_block_height, network) {
 ...
 * @returns {Uint8Array}
 */
export function encode_input_for_fill_order(order_id, fill_amount, destination, nonce, current_block_height, network) {
    const ptr0 = passStringToWasm0(order_id, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
 ...
 * @returns {Uint8Array}
 */
export function encode_input_for_freeze_order(order_id, current_block_height, network) {
    const ptr0 = passStringToWasm0(order_id, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
 ...
 * @returns {Uint8Array}
 */
export function encode_input_for_freeze_token(token_id, is_token_unfreezable, nonce, network) {
    const ptr0 = passStringToWasm0(token_id, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
 ...
 * @returns {Uint8Array}
 */
export function encode_multisig_challenge(public_keys, min_required_signatures, network) {
 ...
 * @returns {Uint8Array}
 */
export function encode_output_produce_block_from_stake(pool_id, staker, network) {
    const ptr0 = passStringToWasm0(pool_id, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
 ...
 * @returns {Uint8Array}
 */
export function encode_partially_signed_transaction(transaction, signatures, input_utxos, input_destinations, htlc_secrets, additional_info, network) {
    const ptr0 = passArray8ToWasm0(transaction, wasm.__wbindgen_malloc);
    const len0 = WASM_VECTOR_LEN;
 ...
 * @returns {Uint8Array}
 */
export function encode_witness(sighashtype, private_key, input_owner_destination, transaction, input_utxos, input_index, additional_info, current_block_height, network) {
 ...
 * @returns {Uint8Array}
 */
export function encode_witness_htlc_refund_multisig(sighashtype, private_key, key_index, input_witness, multisig_challenge, transaction, input_utxos, input_index, additional_info, current_block_height, network) {
    const ptr0 = passArray8ToWasm0(private_key, wasm.__wbindgen_malloc);
    const len0 = WASM_VECTOR_LEN;
 ...
 * @returns {Uint8Array}
 */
export function encode_witness_htlc_refund_single_sig(sighashtype, private_key, input_owner_destination, transaction, input_utxos, input_index, additional_info, current_block_height, network) {
    const ptr0 = passArray8ToWasm0(private_key, wasm.__wbindgen_malloc);
    const len0 = WASM_VECTOR_LEN;
    const ptr1 = passStringToWasm0(input_owner_destination, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len1 = WASM_VECTOR_LEN;
 ...
 * @returns {Uint8Array}
 */
export function encode_witness_htlc_spend(sighashtype, private_key, input_owner_destination, transaction, input_utxos, input_index, secret, additional_info, current_block_height, network) {
    const ptr0 = passArray8ToWasm0(private_key, wasm.__wbindgen_malloc);
    const len0 = WASM_VECTOR_LEN;
    const ptr1 = passStringToWasm0(input_owner_destination, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len1 = WASM_VECTOR_LEN;
 ...
 * @returns {Uint8Array}
 */
export function extract_htlc_secret(signed_tx, strict_byte_size, htlc_outpoint_source_id, htlc_output_index) {
 ...
 * @param {Network} network
 */
export function internal_verify_witness(sighashtype, input_owner_destination, witness, transaction, input_utxos, input_index, additional_info, current_block_height, network) {
 ...
 * @returns {Uint8Array}
 */
export function make_receiving_address_public_key(extended_public_key, key_index) {
    const ptr0 = passArray8ToWasm0(extended_public_key, wasm.__wbindgen_malloc);
    const len0 = WASM_VECTOR_LEN;
 ...
 * @returns {Uint8Array}
 */
export function make_transaction_intent_message_to_sign(intent, transaction_id) {
 ...
 * @param {Network} network
 */
export function verify_transaction_intent(expected_signed_message, encoded_signed_intent, input_destinations, network) {
