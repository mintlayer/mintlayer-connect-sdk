 ...
 * @returns {Uint8Array}
 */
module.exports.extended_public_key_from_extended_private_key = function(private_key_bytes) {
    const ptr0 = passArray8ToWasm0(private_key_bytes, wasm.__wbindgen_malloc);
    const len0 = WASM_VECTOR_LEN;
 ...
 * @returns {Uint8Array}
 */
module.exports.make_receiving_address_public_key = function(extended_public_key_bytes, key_index) {
    const ptr0 = passArray8ToWasm0(extended_public_key_bytes, wasm.__wbindgen_malloc);
    const len0 = WASM_VECTOR_LEN;
 ...
 * @returns {Uint8Array}
 */
module.exports.make_change_address_public_key = function(extended_public_key_bytes, key_index) {
    const ptr0 = passArray8ToWasm0(extended_public_key_bytes, wasm.__wbindgen_malloc);
    const len0 = WASM_VECTOR_LEN;
 ...
 * @returns {string}
 */
module.exports.get_token_id = function(inputs, network) {
    let deferred3_0;
    let deferred3_1;
    try {
 ...
 * @returns {Uint8Array}
 */
module.exports.extract_htlc_secret = function(signed_tx_bytes, strict_byte_size, htlc_outpoint_source_id, htlc_output_index) {
...
module.exports.encode_witness = function(sighashtype, private_key_bytes, input_owner_destination, transaction_bytes, inputs, input_num, network) {
    ...
    const len3 = WASM_VECTOR_LEN;
    const ret = wasm.encode_witness(sighashtype, ptr0, len0, ptr1, len1, ptr2, len2, ptr3, len3, input_num, network);
    if (ret[3]) {
        throw takeFromExternrefTable0(ret[2]);
    }
    var v5 = getArrayU8FromWasm0(ret[0], ret[1]).slice();
 ...
 * @returns {Uint8Array}
 */
module.exports.encode_witness_htlc_secret = function(sighashtype, private_key_bytes, input_owner_destination, transaction_bytes, inputs, input_num, secret, network) {
    const ptr0 = passArray8ToWasm0(private_key_bytes, wasm.__wbindgen_malloc);
    const len0 = WASM_VECTOR_LEN;
    const ptr1 = passStringToWasm0(input_owner_destination, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len1 = WASM_VECTOR_LEN;
    ...
    const len4 = WASM_VECTOR_LEN;
    const ret = wasm.encode_witness_htlc_secret(sighashtype, ptr0, len0, ptr1, len1, ptr2, len2, ptr3, len3, input_num, ptr4, len4, network);
    if (ret[3]) {
        throw takeFromExternrefTable0(ret[2]);
    }
    var v6 = getArrayU8FromWasm0(ret[0], ret[1]).slice();
 ...
 * @returns {Uint8Array}
 */
module.exports.encode_multisig_challenge = function(public_keys_bytes, min_required_signatures, network) {
 ...
 * @returns {Uint8Array}
 */
module.exports.encode_witness_htlc_multisig = function(sighashtype, private_key_bytes, key_index, input_witness, multisig_challenge, transaction_bytes, utxos, input_num, network) {
    const ptr0 = passArray8ToWasm0(private_key_bytes, wasm.__wbindgen_malloc);
    const len0 = WASM_VECTOR_LEN;
    ...
    const len4 = WASM_VECTOR_LEN;
    const ret = wasm.encode_witness_htlc_multisig(sighashtype, ptr0, len0, key_index, ptr1, len1, ptr2, len2, ptr3, len3, ptr4, len4, input_num, network);
    if (ret[3]) {
        throw takeFromExternrefTable0(ret[2]);
    }
    var v6 = getArrayU8FromWasm0(ret[0], ret[1]).slice();
 ...
 * @returns {string}
 */
module.exports.get_transaction_id = function(transaction_bytes, strict_byte_size) {
    let deferred3_0;
    let deferred3_1;
    try {
        const ptr0 = passArray8ToWasm0(transaction_bytes, wasm.__wbindgen_malloc);
 ...
 * @returns {Uint8Array}
 */
module.exports.encode_input_for_fill_order = function(order_id, fill_amount, destination, nonce, network) {
    ...
    const len2 = WASM_VECTOR_LEN;
    const ret = wasm.encode_input_for_fill_order(ptr0, len0, ptr1, ptr2, len2, nonce, network);
    if (ret[3]) {
        throw takeFromExternrefTable0(ret[2]);
    }
    var v4 = getArrayU8FromWasm0(ret[0], ret[1]).slice();
 ...
 * @returns {Uint8Array}
 */
module.exports.encode_input_for_conclude_order = function(order_id, nonce, network) {
    const ptr0 = passStringToWasm0(order_id, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
...
const path = require('path').join(__dirname, 'wasm_wrappers_bg.wasm');
