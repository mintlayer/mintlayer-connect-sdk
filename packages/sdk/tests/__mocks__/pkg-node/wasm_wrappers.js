 ...
 * @param {Network} network
 */
module.exports.verify_transaction_intent = function (
 ...
 * @returns {Uint8Array}
 */
module.exports.encode_stake_pool_data = function (
  value,
  staker,
  vrf_public_key,
  decommission_key,
 ...
 * @returns {Uint8Array}
 */
module.exports.encode_output_issue_nft = function (
  token_id,
  authority,
  name,
  ticker,
  ...
  var ptr9 = isLikeNone(additional_metadata_uri)
    ? 0
    : passStringToWasm0(additional_metadata_uri, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc)
 ...
 * @returns {Uint8Array}
 */
module.exports.encode_output_htlc = function (
  amount,
  token_id,
  secret_hash,
  spend_address,
 ...
 * @returns {Uint8Array}
 */
module.exports.extract_htlc_secret = function (
  signed_tx_bytes,
  strict_byte_size,
 ...
 * @returns {Uint8Array}
 */
module.exports.encode_witness = function (
  sighashtype,
  private_key_bytes,
 ...
 * @returns {Uint8Array}
 */
module.exports.encode_witness_htlc_secret = function (
  sighashtype,
  private_key_bytes,
  input_owner_destination,
  transaction_bytes,
 ...
 * @returns {Uint8Array}
 */
module.exports.encode_witness_htlc_multisig = function (
  sighashtype,
  private_key_bytes,
  key_index,
  input_witness,
 ...
 * @returns {Uint8Array}
 */
module.exports.encode_create_order_output = function (
  ask_amount,
  ask_token_id,
  give_amount,
  give_token_id,
  ...
  var ptr1 = isLikeNone(ask_token_id)
    ? 0
    : passStringToWasm0(ask_token_id, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc)
  var len1 = WASM_VECTOR_LEN
  _assertClass(give_amount, Amount)
  var ptr2 = give_amount.__destroy_into_raw()
  var ptr3 = isLikeNone(give_token_id)
    ? 0
    : passStringToWasm0(give_token_id, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc)
