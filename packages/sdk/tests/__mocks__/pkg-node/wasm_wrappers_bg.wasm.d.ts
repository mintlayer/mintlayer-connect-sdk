...
export const encode_signed_transaction_intent: (a: number, b: number, c: any) => [number, number, number, number]
...
export const get_token_id: (a: number, b: number, c: number) => [number, number, number, number]
